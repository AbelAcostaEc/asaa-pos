    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 transition duration-300 transform bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 lg:translate-x-0 lg:static lg:inset-0">
            ...
            <nav class="mt-4 px-4 space-y-1">
                ...
                <a href="{{ route('administration.users.index') }}" class="flex items-center px-4 py-3 text-sm font-medium {{ request()->routeIs('administration.users.*') ? 'bg-primary/10 text-primary' : 'text-gray-600 dark:text-gray-400' }} rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-all">
